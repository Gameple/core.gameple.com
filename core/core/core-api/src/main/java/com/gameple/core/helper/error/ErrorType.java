...
public enum ErrorType {
    ...
    EXPIRED_TOKEN(HttpStatus.BAD_REQUEST, ErrorCode.E1003, "토큰이 만료되었습니다.", LogLevel.INFO),

    // BRANCH
    COUNTRY_NOT_EXIST(HttpStatus.BAD_REQUEST, ErrorCode.E2001, "국가 정보가 존재하지 않습니다.", LogLevel.INFO);
